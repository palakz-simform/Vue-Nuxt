...
<template>
    <div class="shadow border w-64 mr-10 z-30 h-[190px]">
        ...
        <div class="p-5 flex justify-between relative cursor-pointer border-b">
            ...
            <div class="absolute border shadow left-56 p-5 top-1 -m-1 w-[600px] flex jestify between flex-wrap bg-white"
                v-if="modal.make">
        ...
        <div class="p-5 flex justify-between relative cursor-pointer border-b">
            ...
            <div class="absolute border shadow left-56 p-5 top-1 -m-1 bg-white" v-if="modal.price">
                ...
                <input type="number" placeholder="Max" v-model="priceRange.max">
